...
<html lang="es">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Fraunces:ital,wght@0,400;0,600;1,400&family=Poppins:wght@300;400;500&display=swap"
      rel="stylesheet"
    />
    <style>
      * {
        ...
        <div class="section-gap">
          ...
          <table class="stats">
            ...
            <tbody>
              ...
              <tr>
                <td class="rank">4</td>
                <td class="place">${cities[3].name || "N/A"}</td>
                <td class="place">${cities[3].count || "N/A"}</td>
              </tr>
              <tr>
                <td class="rank">5</td>
                <td class="place">${cities[4].name || "N/A"}</td>
                <td class="place">${cities[4].count || "N/A"}</td>
              </tr>
            </tbody>
          </table>
        </div>
